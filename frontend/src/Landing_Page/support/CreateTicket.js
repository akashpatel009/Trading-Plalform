        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>Zerodha IDFC FIRST Bank 3-in-1 Account</a> <br></br>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>Getting Started</a>
                </div>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }}>Account Modificatoin and Segment Addition</a> <br></br>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }}>Corporate Actoins</a> <br></br>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }}>Sentinel</a> <br></br>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>Kite API</a> <br></br>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>Pi and other platforms</a>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>Stockreports+</a>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>GTT</a>
                </div>
                 
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-5'><i class="fa fa-credit-card" aria-hidden="true"></i> Funds</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>Referral Program</a> <br></br>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }} className='mb-5'>Getting Started</a>
                </div>

                <div className='col-4 p-5 mt-2 mb-'>
                    <h4 className='mb-5'><i class="fa fa-circle-thin" aria-hidden="true"></i> Coin</h4>

                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5"
                     }}>Understanding Mutual Funds</a><br></br>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight:"2.5" }}>Government Securites</a> <br></br>
